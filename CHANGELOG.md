...
- Task now have a dedicated documentation site: https://taskfile.org
  - Thanks to [Docsify](https://docsify.js.org/) for making this pretty easy. To
    ...
    [docs](https://github.com/saturn4er/task/tree/main/docs) directory of this
...
- Implement new `output` option. Please check out the
  [documentation](https://github.com/saturn4er/task#output-syntax)
...
[Taskfile versions](https://github.com/saturn4er/task/blob/main/TASKFILE_VERSIONS.md)
